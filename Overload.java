...
class Overl {
	...
	void ovlDemo() {
		System.out.println("Выполнение метода без парамаетров");
	}
	void ovlDemo(int a) {
		System.out.println("Один параметр типа int: " + a);
	}
	int ovlDemo(int a, int b) {
		System.out.println("Два параметра типа int: " + " " + b);
		return a + b;
...
class Overload {
	public static void main(String[] args) {
		...
		System.out.println();
		resI = ob.ovlDemo(3, 7);
		System.out.println("Результат выполения ob.ovlDemo(3,7):" + resI);
		System.out.println();
		ob.ovlDemo(6);
		System.out.println();
		...
		//Демонстрация инициализации одного обекта на основе другого
