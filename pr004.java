//Передча объектов в качестве аргументов и возвращение объектов методами
class Block {
	private int a,b,c;
	private int v;
...
class pr004 {
	public static void main(String[] args) {
		...
		System.out.println(" объем ob1 равен объему ob2: " + ob1.sameV(ob3));
		...
		//Значения а и b после вызова метода не изменяются
		System.out.println();
