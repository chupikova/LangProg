...
class NumFuncDemo {
	public static void main(String[] args) {
		...
		if (intOb.absEqual(dblob))
			System.out.println("Модули чисел intOb u dblOb равны");
		else
			System.out.println("Модули чисел intOb u dblOb не равны");
		if (intOb.absEqual(dblob))
                        System.out.println("Модули чисел intOb u dOb равны");
		else
                        System.out.println("Модули чисел intOb u dOb не равны");
